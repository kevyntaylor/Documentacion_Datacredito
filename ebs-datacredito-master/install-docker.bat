...
REM [Change to path for production]
RD /S C:\Datacredito\ebs-datacredito\ebs-datacredito\data
...
MD C:\Datacredito\ebs-datacredito\ebs-datacredito\data
